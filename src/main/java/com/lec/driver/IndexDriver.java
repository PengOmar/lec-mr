...
public class IndexDriver {
    private static final Logger LOG = LoggerFactory.getLogger(IndexDriver.class);
...
//        HbaseUtils.createHBaseTableByPartition("nsHBaseTableName", "columnName", 1, "flag");
        ...
        Job job = new JobSotre().creatIndexJob(conf, inPath, outPath, table, regionLocator);
        ...
        //主的控制容器，控制上面的总的两个子作业
        JobControl jobCtrl = new JobControl("idx");
